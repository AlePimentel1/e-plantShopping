...
function ProductList({ onHomeClick }) {
    ...
    const cart = useSelector(state => state.cart.items); //Added to realtime data when cart is updated
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                <span className="cart_quantity_count">{cart?.length > 0 ? cart.length : ''}</span>
                            </h1>
                        </a>
                    </div>
                </div>
